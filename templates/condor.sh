...
transfer_input_files = Anaconda3-2022.10-Linux-x86_64.sh, project.py, .signac, signac_project_document.json, workspace/7623db09eccee41830e4fab767e79c26, qe.yml, submission_scripts/submit-7623db09eccee41830e4fab767e79c26.sh, espresso, operations.py
